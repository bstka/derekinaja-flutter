...
const supabaseUrl = 'CHANGE_THIS';
const supabaseServiceRoleKey = 'CHANGE_THIS';

const googleRoutesApiKey = 'CHANGE_THIS_VALUE';

// Replace with an actual ride ID from your database
const rideId = '31b8b55d-968e-47fb-83d0-bd7c84c47b89';
